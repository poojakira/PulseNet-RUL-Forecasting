...
if not all(os.path.exists(f) for f in [MODEL_FILE, TEST_FEATURES_FILE, GROUND_TRUTH_FILE]):
    raise FileNotFoundError("Ensure model, test_features, and RUL_FD001.txt are in the folder.")
